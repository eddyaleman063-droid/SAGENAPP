  ...
  testWidgets('renders with long title text', (tester) async {
    await tester.pumpWidget(buildApp(
      QuizProgressHeader(
        ...
        total: 20,
        progress: 0.05,
        title: 'Lección muy larga de ciberseguridad y protección de datos personales',
      ),
    ));
    await tester.pump();

    expect(find.text('Lección muy larga de ciberseguridad y protección de datos personales'),
        findsOneWidget);
    await tester.pumpAndSettle();
  });
  ...
  testWidgets('title uses ellipsis overflow', (tester) async {
    await tester.pumpWidget(buildApp(
      QuizProgressHeader(
        ...
        total: 10,
        progress: 0.1,
        title: 'Título extremadamente largo que debería usar ellipsis cuando se desborda del espacio disponible',
      ),
    ));
    await tester.pump();

    final titleText = tester.widget<Text>(
      find.text('Título extremadamente largo que debería usar ellipsis cuando se desborda del espacio disponible'),
    );
