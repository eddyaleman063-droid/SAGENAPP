...
void main() {
  testWidgets('debug dump texts', (tester) async {
    ...
    final pass = ProviderScope.containerOf(tester.element(find.byType(SagenPassScreen)))
        .read(sagenPassProvider);
    debugPrint('PASS: currentLevel=${pass.currentLevel} sp=${pass.currentSP} claimed=${pass.claimedLevels}');
