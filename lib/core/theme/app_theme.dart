...
class AppTheme {
  ...
  static ThemeData get highContrastLight => _cachedHighContrastLight ??= light.copyWith(
  ...
  static ThemeData get highContrastDark => _cachedHighContrastDark ??= dark.copyWith(
        colorScheme: ColorScheme.fromSeed(
          seedColor: PremiumColors.primary,
          brightness: Brightness.dark,
        ).copyWith(
