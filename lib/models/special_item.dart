...
extension SpecialItemTypeProperties on SpecialItemType {
  ...
  String get description {
    switch (this) {
      case SpecialItemType.focusElixir:
        return 'Multiplies EXP x2 for 15 min';
      case SpecialItemType.phoenixFeather:
        return 'Revives streak if lost less than 24h ago';
      case SpecialItemType.sageMonocle:
        return 'Removes 2 wrong answers in a challenge';
      case SpecialItemType.titaniumShield:
        return 'Auto-protects streak if you miss a day';
      case SpecialItemType.luckBoost:
        return '+15% chest rarity boost for 30 min';
      case SpecialItemType.timeWarp:
        return 'Skip cooldown on next lesson review';
      case SpecialItemType.avatarFrameNeon:
        return 'Animated neon glow frame for your avatar';
      case SpecialItemType.avatarFrameDragon:
        return 'Dragon fire frame for your avatar';
      case SpecialItemType.avatarFrameCrystal:
        return 'Ice crystal frame for your avatar';
      case SpecialItemType.avatarFrameSkull:
        return 'Legendary skull flame frame';
      case SpecialItemType.avatarFrameGalaxy:
        return 'Epic galaxy star frame';
      case SpecialItemType.titleCyberSage:
        return 'Exclusive "Cyber Sage" display title';
      case SpecialItemType.titleNightGuardian:
        return 'Exclusive "Night Guardian" display title';
      case SpecialItemType.titleDigitalPhoenix:
        return 'Exclusive "Digital Phoenix" display title';
      case SpecialItemType.titleShadowHacker:
        return 'Epic "Shadow Hacker" display title';
      case SpecialItemType.titleStormBreaker:
        return 'Rare "Storm Breaker" display title';
      case SpecialItemType.themeDarkFire:
        return 'Dark fire color theme for the app';
      case SpecialItemType.themeCyberNeon:
        return 'Cyber neon color theme for the app';
      case SpecialItemType.effectDigitalRain:
        return 'Animated digital rain profile effect';
      case SpecialItemType.effectFireTrail:
        return 'Animated fire trail profile effect';
    }
  }
...
class SpecialItem {
  ...
  const SpecialItem({required this.type, this.quantity = 0, this.activeUntil});

  bool get isActive =>
      activeUntil != null && DateTime.now().isBefore(activeUntil!);
