...
class LocalFallbackService implements AiService {
  ...
  String _generateLocalResponse(String userMessage) {
    ...
    if (msg.contains('hola') ||
        msg.contains('buenos dias') ||
        msg.contains('buenas tardes') ||
        msg.contains('buenas noches') ||
        msg.contains('que tal') ||
        msg.contains('como estas') ||
        msg.contains('hello') ||
        _wordMatch(msg, 'hi') ||
        _wordMatch(msg, 'hey') ||
        ...
        _wordMatch(msg, 'howdy') ||
        _wordMatch(msg, 'sup') ||
        msg.contains('whats up') ||
        msg.contains('how are you')) {
      return [
    ...
    if (msg.contains('gracias') ||
        ...
        msg.contains('thx') ||
        msg.contains('muy util') ||
        msg.contains('muy util') ||
        msg.contains('muchas gracias') ||
        msg.contains('thanks') ||
        msg.contains('appreciate') ||
        msg.contains('very helpful') ||
        msg.contains('thanks a lot') ||
        msg.contains('cheers') ||
        msg.contains('grateful')) {
      return [
    ...
    if (msg.contains('adios') ||
        msg.contains('hasta luego') ||
        msg.contains('nos vemos') ||
        msg.contains('chau') ||
        msg.contains('bye') ||
        msg.contains('goodbye') ||
        msg.contains('see you') ||
        msg.contains('later') ||
        msg.contains('farewell') ||
        msg.contains('take care') ||
        msg.contains('see ya') ||
        msg.contains('gotta go')) {
      return [
    ...
    if (msg.contains('no entiendo') ||
        msg.contains('confundido') ||
        msg.contains('explicar') ||
        msg.contains('no claro') ||
        msg.contains('mas simple') ||
        msg.contains('mas claro') ||
        msg.contains('repetir') ||
        msg.contains('otra vez') ||
        msg.contains('que quieres decir') ||
        msg.contains('puedes reformular') ||
        msg.contains("don't understand") ||
        msg.contains('confused') ||
        msg.contains('explain') ||
        msg.contains('unclear') ||
        msg.contains('simpler') ||
        msg.contains('clearer') ||
        msg.contains('repeat') ||
        msg.contains('again') ||
        msg.contains('what do you mean') ||
        msg.contains('can you rephrase')) {
      return [
    ...
    if (msg.contains('como estas') ||
        msg.contains('que tal') ||
        msg.contains('como vas') ||
        msg.contains('todo bien') ||
        msg.contains('que haces') ||
        msg.contains('que paso') ||
        msg.contains('como estas') ||
        msg.contains('how are you') ||
        msg.contains("what's up") ||
        msg.contains("how's it going") ||
        msg.contains('you okay') ||
        msg.contains('what are you doing') ||
        msg.contains("what's new") ||
        msg.contains("how've you been")) {
      return _defaultResponses[_random.nextInt(_defaultResponses.length)];
    }

    if (msg.contains('phishing') ||
        msg.contains('phising') ||
        msg.contains('correo falso') ||
        msg.contains('estafa por correo') ||
        msg.contains('suplantacion') ||
        msg.contains('impersonation') ||
        msg.contains('fake email') ||
        msg.contains('scam email') ||
        msg.contains('spoofing')) {
      return _getRandomResponse('phishing');
    }

    if (msg.contains('contraseña') ||
        msg.contains('contrasena') ||
        msg.contains('clave') ||
    ...
    if (msg.contains('navegacion') ||
        msg.contains('navegar') ||
        msg.contains('internet') ||
        msg.contains('pagina web') ||
        msg.contains('sitio web') ||
        msg.contains('https') ||
        msg.contains('certificado') ||
        msg.contains('peligroso') ||
        msg.contains('descargar') ||
        msg.contains('browsing') ||
        msg.contains('browse') ||
        msg.contains('website') ||
        msg.contains('web page') ||
        msg.contains('dangerous') ||
        (msg.contains('download') && !msg.contains('malware'))) {
      return _getRandomResponse('safe browsing');
    }

    if (msg.contains('redes sociales') ||
        msg.contains('instagram') ||
        msg.contains('facebook') ||
        msg.contains('tiktok') ||
        msg.contains('twitter') ||
        msg.contains('x ') ||
        msg.contains('whatsapp') ||
        msg.contains('privacidad') ||
        msg.contains('publicar') ||
        msg.contains('etiquetar') ||
        msg.contains('perfil') ||
        msg.contains('social media') ||
        msg.contains('posting') ||
        msg.contains('tag') ||
    ...
    if (msg.contains('wifi') ||
        msg.contains('wi-fi') ||
        msg.contains('router') ||
        msg.contains('inalambrico') ||
        msg.contains('vpn') ||
        msg.contains('red publica') ||
        msg.contains('cafeteria') ||
        msg.contains('conectar') ||
        msg.contains('wireless') ||
        msg.contains('public network') ||
        msg.contains('cafe') ||
        msg.contains('connect')) {
      return _getRandomResponse('wifi security');
    }

    if (msg.contains('virus') ||
        msg.contains('malware') ||
        msg.contains('trojan') ||
        msg.contains('ransomware') ||
        msg.contains('spyware') ||
        msg.contains('antivirus') ||
        msg.contains('infectado') ||
        msg.contains('infeccion') ||
        msg.contains('infected') ||
        msg.contains('infection')) {
      return _getRandomResponse('malware');
    }

    if (msg.contains('identidad') ||
        msg.contains('robo de datos') ||
        msg.contains('robar identidad') ||
        msg.contains('robo de identidad') ||
        msg.contains('pasaporte') ||
        msg.contains('documento') ||
        msg.contains('tarjeta de credito') ||
        msg.contains('financiero') ||
        msg.contains('identity') ||
        msg.contains('data theft') ||
        msg.contains('steal identity') ||
        msg.contains('identity theft') ||
    ...
    if (msg.contains('estafa') ||
        msg.contains('fraude') ||
        msg.contains('truco') ||
        msg.contains('dinero facil') ||
        msg.contains('premio') ||
        msg.contains('loteria') ||
        msg.contains('falso') ||
        msg.contains('engañar') ||
        msg.contains('scam') ||
        msg.contains('con') ||
        msg.contains('easy money') ||
        msg.contains('lottery') ||
        msg.contains('fake') ||
        msg.contains('deceive')) {
      return _getRandomResponse('online scams');
    }

    if (msg.contains('huella digital') ||
        msg.contains('rastro') ||
        msg.contains('permanente') ||
        msg.contains('busqueda') ||
        msg.contains('google') ||
        msg.contains('reputacion en linea') ||
        msg.contains('footprint') ||
        msg.contains('trace') ||
        msg.contains('search') ||
        msg.contains('online reputation')) {
      return _getRandomResponse('digital footprint');
    }

    if (msg.contains('ciberbullying') ||
        msg.contains('acoso') ||
        msg.contains(' acosador') ||
        msg.contains('humillar') ||
        msg.contains('amenazar') ||
        msg.contains('insultar') ||
        msg.contains('intimidar') ||
        msg.contains('bullying') ||
        msg.contains('harassment') ||
        msg.contains('cyberbully') ||
        msg.contains('humiliate') ||
        msg.contains('threaten') ||
        msg.contains('insult') ||
        msg.contains('intimidate')) {
