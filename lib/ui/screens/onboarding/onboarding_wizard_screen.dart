...
class _OnboardingWizardScreenState extends ConsumerState<OnboardingWizardScreen> {
  ...
  Widget _buildStep(int index) {
    final wizardSteps = OnboardingWizardConfig.localizedSteps(_l);
    switch (index) {
      case 0: return const WizardPresentationStep();
      case 1: return WizardSingleChoiceStep(stepIndex: 1, stepConfig: wizardSteps[1]);
      case 2: return WizardLevelStep(stepIndex: 2, stepConfig: wizardSteps[2]);
      case 3: return WizardMultiChoiceStep(stepIndex: 3, stepConfig: wizardSteps[3]);
      case 4: return WizardSingleChoiceStep(stepIndex: 4, stepConfig: wizardSteps[4]);
      case 5: return WizardMultiChoiceStep(stepIndex: 5, stepConfig: wizardSteps[5]);
      case 6: return WizardGoalStep(stepIndex: 6, stepConfig: wizardSteps[6]);
      case 7: return WizardCommitmentStep(
        stepIndex: 7,
        stepConfig: wizardSteps[7],
        sageMessageForStep: _sageMessageForStep,
      );
      case 8: return WizardConfirmationStep(
