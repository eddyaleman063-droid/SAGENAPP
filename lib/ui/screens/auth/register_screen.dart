...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      SagenNotification.show(
        context,
        message: AppLocalizations.of(context)!.authCreateAccountError,
        type: NotificationType.error,
      );
    } finally {
  ...
  Future<void> _handleGoogleRegister() async {
    ...
    try {
      ...
      SagenNotification.show(
        context,
        message: AppLocalizations.of(context)!.authRegisterGoogleError,
        type: NotificationType.error,
      );
    } finally {
      if (mounted) setState(() => _isLoading = false);
  ...
  Future<void> _handleFacebookRegister() async {
    ...
    try {
      ...
      SagenNotification.show(
        context,
        message: AppLocalizations.of(context)!.authRegisterFacebookError,
        type: NotificationType.error,
      );
    } finally {
      if (mounted) setState(() => _isLoading = false);
                          ...
                          children: [
                            ...
                            Semantics(
                              ...
                              child: TextFormField(
                                ...
                                validator: (v) {
                                  if (v == null || v.isEmpty) {
                                    return l.registerAgeEmpty;
                                  }
                                  final age = int.tryParse(v);
                                  if (age == null || age < 13) {
                                    return l.registerAgeMin;
                                  }
